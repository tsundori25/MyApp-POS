...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>Toko</b>Lancar</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- Menu User Right-->
              <li class="user-panel-right">
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat bg-green">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?=site_url('auth/logout')?>" class="btn btn-default btn-flat bg-red">Logout</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview" > 
          <a href="<?=site_url('dashboard')?>">
            <i class="fa fa-dashboard" <?=$this->uri->segment(1) == 'dashboard' ? 'active' : ''?>></i> <span>Dashboard</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li  <?=$this->uri->segment(1) == 'assets/index.html' ? 'class="active"' : ''?>><a href="<?=base_url()?>assets/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li  <?=$this->uri->segment(1) == 'supplier' ? 'class="active"' : ''?>><a href="<?=base_url()?>assets/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        ...
        <li class="treeview <?=$this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' ? 'active' : ''?>">
          ...
          <ul class="treeview-menu" >
            ...
            <li <?=$this->uri->segment(1) == 'supplier' ? 'class="active"' : ''?>><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> Stock</a></li>
            <li <?=$this->uri->segment(1) == 'supplier' ? 'class="active"' : ''?>><a href="../charts/inline.html"><i class="fa fa-circle-o"></i> Retur</a></li>
          </ul>
        </li>
		 <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> Purchase</a></li>
			<li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> Expenditure</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 | Toko Lancar </strong>
  </footer>
</div>
<!-- ./wrapper -->
