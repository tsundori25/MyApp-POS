...
class item_m extends CI_Model {
    ...
    private function _get_datatables_query() {
        $this->db->select('p_item.*, p_categori.name as category_name, p_unit.name as unit_name');
        $this->db->from('p_item');
        $this->db->join('p_categori', 'p_item.category_id = p_categori.category_id');
    ...
    public function get($id = null) 
    {
        $this->db->select('p_item.*, p_categori.name as category_name, p_unit.name as unit_name');
        $this->db->from('p_item');
        $this->db->join('p_categori', 'p_categori.category_id = p_item.category_id');
